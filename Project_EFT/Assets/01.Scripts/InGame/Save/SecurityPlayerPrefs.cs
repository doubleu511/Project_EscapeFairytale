...
public class SecurityPlayerPrefs
{
    ...
    {
        // 8 바이트로 하고, 변경해서 쓸것
        byte[] saltBytes = new byte[] { 39, 23, 43, 52, 15, 26, 32, 28 };

        // 길이 상관 없고, 키를 만들기 위한 용도로 씀
        string randomSeedForKey = "7a910e7df819e8b0c9a7e9f089c0b9a0e9";

        // 길이 상관 없고, aes에 쓸 key 와 iv 를 만들 용도
        string randomSeedForValue = "0a3d98a5900cea86799b7c999e7f67f8f9f6";
